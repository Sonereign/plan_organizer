...
if __name__ == "__main__":
    INPUT_FILE = "sources/availabilityPerZone2024.xls"
    OUTPUT_FILE = "zone_stage5_output_2024.xlsx"

    # Run stage4
    per_zone_per_type_stage5_previous_years(INPUT_FILE, OUTPUT_FILE, 2024)
